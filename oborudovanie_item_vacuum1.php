    		...
    		<section class="equipment">
    			<div class="equipment_wrap">
					<div class="breadcrumbs">
						...
						<a href="./oborudovanie_item_vacuum1.php" class="about equipment">> Vacuum Cleaner</a>
					</div>
...
<!--								<h1 class="main_info_title">Обменный терминал «AquaСhange»</h1>-->
								<div class="pic_block">
									<div class="main_pic">
										<img class="main_goods" src="./img/equip_item_page/aspiratore_vacuum.jpg" alt="main_goods">
									</div>
								</div>								
								<div class="text_block">
									<h1>Пылесос самообслуживания на один пост Aquarama Vacuum Cleaner</h1>
									
									<h4>Технические характеристики:</h4>
									<p>Корпус из нержавеющей стали</p>
									<p>Гибкий шланг длинной 5 метров + аксессуары</p>
