    		...
    		<section class="equipment">
    			<div class="equipment_wrap">
					<div class="breadcrumbs">
						...
						<a href="./oborudovanie_item_paper_d.php" class="about equipment">> Диспенсер для протирочной бумаги</a>
					</div>
...
<!--								<h1 class="main_info_title">Обменный терминал «AquaСhange»</h1>-->
								<div class="pic_block">
									<div class="main_pic">
										<img class="main_goods" src="./img/equip_item_page/paper_d.jpg" alt="main_goods">
									</div>
								</div>								
								<div class="text_block">
									<h1>Диспенсер для протирочной бумаги</h1>
