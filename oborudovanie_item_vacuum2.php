    		...
    		<section class="equipment">
    			<div class="equipment_wrap">
					<div class="breadcrumbs">
						...
						<a href="./oborudovanie_item_vacuum2.php" class="about equipment">>Twin Vacuum Cleaner</a>
					</div>
...
<!--								<h1 class="main_info_title">Обменный терминал «AquaСhange»</h1>-->
								<div class="pic_block">
									<div class="main_pic">
										<img class="main_goods" src="./img/equip_item_page/twin_vacuum.jpg" alt="main_goods">
									</div>
								</div>								
								<div class="text_block">
									<h1>Пылесос самообслуживания на два поста Aquarama Twin Vacuum</h1>
