    		...
    		<section class="equipment">
    			<div class="equipment_wrap">
					<div class="breadcrumbs">
						...
						<a href="./oborudovanie_item_tyre_inflator.php" class="about equipment">> Устройство для подкачки шин</a>
					</div>
...
<!--								<h1 class="main_info_title">Обменный терминал «AquaСhange»</h1>-->
								<div class="pic_block">
									<div class="main_pic">
										<img class="main_goods" src="./img/equip_item_page/tyre_inflator.jpg" alt="main_goods">
									</div>
								</div>								
								<div class="text_block">
									<h1>Устройство для подкачки шин</h1>
									
									<h4>Технические характеристики:</h4>
									<p>Конструкция из нержавеющей стали</p>
									<p>Спиральный шланг, длинной 8 метров +пистолет для подкачки</p>
									<p>Светодиодная индикация окончания цикла</p>
									<p>Электронный монето/жетоноприёмник</p>
